...
export default function TemplateManager({ onClone, onCreate }) {
  ...
  return (
    <div className="space-y-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <button 
          onClick={onCreate}
          className="p-10 rounded-[3rem] nm-flat border-2 border-dashed border-white/10 flex flex-col items-center justify-center text-center opacity-30 hover:opacity-100 hover:border-blue-500/30 transition-all group"
        >
